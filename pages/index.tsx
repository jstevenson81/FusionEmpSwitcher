...
export default function Home() {
    ...
    const [selWorker, setSelWorker] = useState<FusionWorker | null>(null);
                ...
                <Grid container spacing={4}>
                    {tiedUser && (
                        <Grid item xs={12}>
                            <Alert
                                ...
                                <Box sx={{ mb: 1 }}>
                                    <Typography variant='caption'>
                                        Congratulations! You updated the user
                                        account:{' '}
                                        <strong>{selUser?.Username}</strong> to
                                        be the employee:{' '}
                                ...
                                <Typography variant='caption' component='small'>
                                    <strong>
                                        NOTE: If you want to switch back, just
                                        select the employee from the drop down
                                        list and tie back to that user account.
                                    </strong>
                                </Typography>
                            </Alert>
                        </Grid>
                    ...
                    <Grid item xs={12}>
                        <Autocomplete
                            ...
                            sx={{ width: '100%' }}
                            getOptionLabel={(option: FusionWorker) => {
                                return `${option.names[0].DisplayName} - ${option.PersonNumber}`;
                            }}
                            onChange={(
                                event: any,
                                newValue: FusionWorker | null,
                            ) => {
